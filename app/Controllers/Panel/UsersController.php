...
class UsersController extends MasterController
{
    ...
    public function edit(Request $request) :Response
    {
        ...
        return view('panel.users.edit', $data)->render();
    }
    ...
    {
        return view('panel.users.create', $this->csrf($request))->render();
    }
    ...
    public function update(Request $request) :Response
    {
        ...
        if ($validateData === false) {
            return response()->withRedirect('/panel/users/edit/'.$id, 301);
        }
    ...
    public function insert(Request $request) :Response
    {
        ...
        if ($validateData === false) {
            ...
            session()->set('users.create.role', $data['role']);

            return response()->withRedirect('/panel/users/create', 301);
        }
